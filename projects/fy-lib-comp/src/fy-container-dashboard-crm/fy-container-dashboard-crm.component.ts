...
@Component({
  selector: 'fy-container-dashboard-crm',
  standalone: true,
  templateUrl: './fy-container-dashboard-crm.component.html',
  styleUrls: ['./fy-container-dashboard-crm.component.css'],
  imports: [CommonModule, FySidebarComponent, BadgeComponent, FyNavbarComponent, FyCardDateComponent]
})
export class FyContainerDashboardCrmComponent implements OnInit, AfterViewInit {
