...
@Component({
  selector: 'fy-table-crm',
  standalone: true,
  encapsulation: ViewEncapsulation.None,
  templateUrl: './fy-table-crm.component.html',
  styleUrls: ['./fy-table-crm.component.css'],
  animations: [
    trigger('fadeInOut', [
      state('void', style({
        opacity: 0
...
export class FyTableCrmComponent implements OnInit {
  ...
  @Input() paginator: boolean = false; //Afirma si se quiere o no la paginacion
