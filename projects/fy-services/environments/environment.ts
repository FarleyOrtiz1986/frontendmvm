export const environment = {
  ...
  localStorageUsuario: "localStorageUsuario",

  messageErrorHttpGeneral: "Ups, algo no salio bien. Intenta ejecutar esta acción un poco más tarde, primero intenta recargar la página y validar que tu conexión a internet este estable.",

  regularExpressEmail: /^(([^<>()\[\]\\.,;:\s@”]+(\.[^<>()\[\]\\.,;:\s@”]+)*)|(“.+”))@((\[[0–9]{1,3}\.[0–9]{1,3}\.[0–9]{1,3}\.[0–9]{1,3}])|(([a-zA-Z\-0–9]+\.)+[a-zA-Z]{2,}))$/,

  /** Permite indicar el tipo de campo que va a llevar la tabla */
  typeField: {
    imgProfile: 'imageProfile', // filtra los datos segun la imagen
    ...
    currency_usd: 'usd', // filtra los datos en función de una opción seleccionada en un menú desplegable
    finit_options: 'finit_options' // Opciones finitas que que implican estados 
  },
  ...
  type_field: {
    ...
    percentage: 'percentage', // filtra los datos con el tipo porcentaje
    currency_cop: 'cop', // filtra los datos en función de una opción seleccionada en un menú desplegable
    finit_options :'finit_options', // filtra los datos en función de una opción seleccionada en un menú desplegable
  },
